...
public class XSSFRowExtractor extends DefaultHandler {
	 ...
	 */
	private final BetterSheetContentsHandler output;
	 ...
	 */
	public XSSFRowExtractor(StylesTable styles, CommentsTable comments, ReadOnlySharedStringsTable strings, BetterSheetContentsHandler rowHandler, boolean formulasNotResults) {
		this.stylesTable = styles;
		this.commentsTable = comments;
		this.sharedStringsTable = strings;
		this.output = rowHandler;
	...
	public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
		...
		} else if ("oddHeader".equals(name) || "evenHeader".equals(name) || "firstHeader".equals(name) || "firstFooter".equals(name) || "oddFooter".equals(name)
				|| "evenFooter".equals(name)) {
			hfIsOpen = true;
			// Clear contents cache
	...
	public void endElement(String uri, String localName, String name) throws SAXException {
		String thisStr = null;
		CTCellImpl i = new CTCellImpl(null);
	...
	public interface BetterSheetContentsHandler {
		void startRow(int rowNum);
		void endRow(int rowNum);
		void cell(int celltype, String cellReference, String formattedValue, XSSFComment comment);
